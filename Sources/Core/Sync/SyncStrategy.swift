...
enum SyncOrigin: String, Sendable, Equatable, CaseIterable {
...
struct SyncedUser: Sendable, Equatable {
    let user: User
...
extension UserPersistenceService {
    ...
    func writeThrough(_ user: User) async throws {
        do {
...
final class MockSyncStrategy: SyncStrategy {
