...
package struct AppButton_Previews: PreviewProvider {
...
package struct AppTextField_Previews: PreviewProvider {
    package static var previews: some View {
        Group {
            VStack(spacing: 24) {
                AppTextField(
...
package struct LoadingView_Previews: PreviewProvider {
    package static var previews: some View {
        Group {
            ZStack {
...
package struct AdaptiveStack_Previews: PreviewProvider {
    package static var previews: some View {
        Group {
