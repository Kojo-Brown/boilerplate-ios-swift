...
package struct LayoutContext: Equatable {
    package let horizontal: UserInterfaceSizeClass
    package let vertical: UserInterfaceSizeClass
    package let size: CGSize

    package var isCompact: Bool { horizontal == .compact }
    package var isRegular: Bool { horizontal == .regular }
    package var isLandscape: Bool { size.width > size.height }

    /// Preferred grid column count derived from size class and orientation.
    package var preferredColumnCount: Int {
...
/// ```
package struct AdaptiveStack<Content: View>: View {
...
/// ```
package struct AdaptiveGrid<Data: RandomAccessCollection, Content: View>: View
where Data.Element: Identifiable {
    package let data: Data
    package let spacing: CGFloat
    package let minColumnWidth: CGFloat
    @ViewBuilder package let content: (Data.Element) -> Content
...
/// }
/// ```
package struct AdaptiveContainer<Content: View>: View {
    @ViewBuilder package let content: (LayoutContext) -> Content

    @Environment(\.horizontalSizeClass) private var horizontalSizeClass
    @Environment(\.verticalSizeClass) private var verticalSizeClass

    package init(@ViewBuilder content: @escaping (LayoutContext) -> Content) {
        self.content = content
    }
...
extension EnvironmentValues {
    ...
    package var layoutContext: LayoutContext {
