...
/// edit.
package struct CachingUserRepository: UserRepositoryDecorator {
    ...
    package static let defaultTimeToLive: Duration = .seconds(5)
    ...
    package enum CacheKey: Hashable, Sendable {
        case currentUser
    }
    ...
    package struct CachedUser: Sendable {
        package let user: User
        package let storedAt: ContinuousClock.Instant
    }
